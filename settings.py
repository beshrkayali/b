...
SITE_ROOT = "/"
SITE_WWW_URL = "http://yoursite.com"
SITE_NAME = "Where the Buggalo Roam"
...
CONTEXT = {
    ...
    'SITE_DESCRIPTION': "One hundred <a href='#'>dollars</a>. There's one way and only one way to determine if an animal is intelligent. Dissect its brain! Bender, we're trying our best. I'll get my kit!",
    'SITE_DESCRIPTION_TEXT': "One hundred dollars. There's one way and only one way to determine if an animal is intelligent. Dissect its brain! Bender, we're trying our best. I'll get my kit!",
    'SITE_DESCRIPTION_TEXT_SHORT': "Bender, we're trying our best. I'll get my kit!",
    'GA_ACCOUNT':'UA-33509549-1',
    'TWITTER_ACCOUNT':'beshr',
    'GITHUB_ACCOUNT':'beshrkayali',
}
